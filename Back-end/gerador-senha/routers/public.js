...
router.get("/list-passwords", async (req, res) => {
  try {
    ...
    res.json({ message: "Erro: Houve um problema ao listar as senhas", error });
  }
});
...
router.post("/insert-passwords", async (req, res) => {
  try {
    ...
    res.json({message: "Erro: Houve um problema ao salvar a senha", error});
  }
});
...
router.delete("/del-passwords/:id", async (req, res) => {
  try {
    ...
    res.json({ message: "Erro: Houve um problema ao deletar a senha", error });
  }
});
